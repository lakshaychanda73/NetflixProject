...
Research was conducted from a network-restricted environment where direct page
retrieval was blocked for all external domains, including the developer's own sites.
Findings were assembled from search-indexed content. Every figure carries a
confidence marker (Verified / Reported / Estimate / Gap) and a source. Re-verify all
